...
(() => {
  ...
  const PATHS = {
    ...
    external: ['M14 4h6v6', 'M20 4 11 13',
  ...
  function setupCard() {
    ...
    c.appendChild(warnBox('Catalogo non ancora scaricato',
  ...
  function offersCard() {
    ...
    if (state.needLogin && state.offers.length) {
      c.appendChild(warnBox('Sessione scaduta',
        'Devi fare login su Corporate Benefits per usare questi sconti.'));
    }
  ...
  function close() { document.getElementById('discount-check-root')?.remove(); }
})();
